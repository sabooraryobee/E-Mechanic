...
public class OwnerMessagingCustomer extends Activity {
    FirebaseUser Fuser;
    String recieverID;
    ...
    public void checkChatRoomExist(){
        if(!commons.customerID.equals("")) {
            commons.users.child(Fuser.getUid()).child("chatrooms").equalTo("members", commons.assignedMechanicID)
                    .get()
            ...
            Toast.makeText(OwnerMessagingCustomer.this, "no client", Toast.LENGTH_SHORT).show();
        }
    }
