...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    private String rideId, currentUserId, customerId, mechanicId, userMechanicOrCustomer;
   ...
   //     mRatingBar.setVisibility(View.VISIBLE);
    ...
    /*    mRatingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                DatabaseReference mMechanicRatingDb = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanics").child(mechanicId).child("rating");
                mMechanicRatingDb.child(rideId).setValue(rating);
            }*/
      //  });
        if(customerPaid){
    ...
    private PayPalConfiguration config = new PayPalConfiguration()
            ...
            .clientId(PayPalConfiguration.getClientMetadataId(HistorySingleActivity.this));
    ...
    private void getUserInformation(String otherUserMechanicOrCustomer, String otherUserId) {
